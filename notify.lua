-- Notification System for Exploit Execution
...
function CreateNotification(title, content, duration)
...
--🔹 Example calls during testing
CreateNotification("Testing", "Hello from exploit script!", 5)
task.wait(2)
CreateNotification("Info", "Everything looks good.", 4)
